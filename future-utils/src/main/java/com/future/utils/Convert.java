...
public class Convert {
	 ...
	 * @return 结果
	 */
	public static Long[] toLongArray(boolean isIgnoreConvertError, Object... values) throws Exception {
		if (CollectionKit.isEmpty(values)) {
			return new Long[] {};
		}
	 ...
	 * @return 结果
	 */
	public static Double[] toDoubleArray(boolean isIgnoreConvertError, Object... values) throws Exception {
		if (CollectionKit.isEmpty(values)) {
			return new Double[] {};
		}
		...
		for (int i = 0; i < values.length; i++) {
			...
			if (null == v && isIgnoreConvertError == false) {
				throw new Exception(StrKit.format("Convert [{}] to Double error!", values[i]));
			}
			doubles[i] = v;
		}
		return doubles;
	 ...
	 * @return 结果
	 */
	public static <T> Float[] toFloatArray(boolean isIgnoreConvertError, Object... values) throws Exception {
		if (CollectionKit.isEmpty(values)) {
			return new Float[] {};
		}
		...
		for (int i = 0; i < values.length; i++) {
			...
			if (null == v && isIgnoreConvertError == false) {
				throw new Exception(StrKit.format("Convert [{}] to Float error!", values[i]));
			}
			floats[i] = v;
		}
		return floats;
	 ...
	 * @return 结果
	 */
	public static Boolean[] toBooleanArray(boolean isIgnoreConvertError, Object... values) throws Exception {
		if (CollectionKit.isEmpty(values)) {
			return new Boolean[] {};
		}
		...
		for (int i = 0; i < values.length; i++) {
			...
			if (null == v && isIgnoreConvertError == false) {
				throw new Exception(StrKit.format("Convert [{}] to Boolean error!", values[i]));
			}
			bools[i] = v;
		}
		return bools;
