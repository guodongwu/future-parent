...
public class ZipStrUtil {
    ...
    public static void main(String[] args) throws IOException {
        String str="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEiLCJsb2dpblRpbWUiOiIyMDE3LTEwLTE4IDE2OjIzOjA2IiwibmFtZSI6ImFkbWlucyIsInJvbGUiOiLotoXnuqfnrqHnkIblkZgiLCJsb2dpbk5hbWUiOiJhZG1pbnMifQ.MEtuKeSgICmTXrBUMiNyQi_tdV6Mgd4BbzKCeICTyvE";
